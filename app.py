...
def spelling_accuracy(extracted_text):
    try:
        ...
        print(f"Error in spelling_accuracy: {e}")
        return 85.0  # Default spelling accuracy
...
def gramatical_accuracy(extracted_text):
    try:
        ...
        print(f"Error in gramatical_accuracy: {e}")
        return 80.0  # Default grammatical accuracy
...
def percentage_of_corrections(extracted_text):
    try:
        ...
        if 'flaggedTokens' in json_response:
            ...
            return 5.0  # Default correction percentage
    except Exception as e:
        print(f"Error in percentage_of_corrections: {e}")
...
#'''-------------------------------------------------------------------------------------------------------------------------------------------------------------------------'''
    ...
    def listen_for(seconds: int):
        try:
            ...
            st.error("Microphone access error. Please check permissions.")
